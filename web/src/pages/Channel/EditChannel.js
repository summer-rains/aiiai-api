    ...
    if (name === 'type') {
      ...
      switch (value) {
        ...
        case 62:
          localModels = [
            'kling-v1_images',
            'kling-v1_videos_std_5',
            'kling-v1_videos_std_10',
            'kling-v1_videos_pro_5',
            'kling-v1_videos_pro_10',
