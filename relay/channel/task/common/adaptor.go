...
func (a *TaskAdaptor) BuildRequestHeader(c *gin.Context, req *http.Request, info *relaycommon.TaskRelayInfo) error {
	...
	if info.RelayMode == relayconstant.RelayModeRunwayGenerations || info.RelayMode == relayconstant.RelayModeRunwayTasks {
		if version := c.Request.Header.Get("X-Runway-Version"); version != "" {
			req.Header.Set("X-Runway-Version", c.Request.Header.Get("X-Runway-Version"))
		}
	}
	return nil
}
...
func (a *TaskAdaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.TaskRelayInfo) (taskID string, taskData []byte, taskErr *dto.TaskError) {
	...
	//if info.RelayMode < relayconstant.RelayModeLumaGenerations {
	...
	//
	//	var taskId string
	//	if info.RelayMode == relayconstant.RelayModeLumaGenerations || info.RelayMode == relayconstant.RelayModeLumaExtend {
...
func (a *TaskAdaptor) CommonFetchTask(baseUrl, key string, body map[string]any, action string, platform constant.TaskPlatform) (*http.Response, error) {
	var requestUrl string
	if platform == constant.TaskPlatformLuma {
		requestUrl = fmt.Sprintf("%s/luma/tasks", baseUrl)
	}
